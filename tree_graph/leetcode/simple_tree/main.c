...
* Date   : Wednesday June  3, 2020. 11:15AM
* File   : main.c
*
***/
...
*/
			...
			case 12:
				printf("\nMirror Copy : \n");
				root_new = create_node(15);
				root_new = mirror_copy(root);
				printf ("\n mirror_copy --> \n");
				m_preorder(root_new);
				break;
			case 13:
				printf("\nLeetCode :Invert Tree \n");
				//				root_new = create_node(25);
				root_new = invertTree(root);
				m_inorder(root_new);
				break;
		        default : {
